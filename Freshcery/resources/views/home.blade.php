...
@section('content')
    ...
    <div id="page-content" class="page-content" style="margin-top: -25px">
        ...
        <section id="categories" class="pb-0 gray-bg">
            ...
            <div class="container">
                <div class="landing-categories owl-carousel owl-theme">
                    @foreach ($categories as $category)
                        <div class="item">
                            <div class="card rounded-0 border-0 text-center">
                                <img src="{{ asset('assets/img/' . $category->image) }}" class="img-fluid">
                                <div class="card-img-overlay d-flex align-items-center justify-content-center">
                                    <a href="{{ route('single.category', $category->id) }}"
                                        class="btn btn-primary btn-lg">{{ $category->name }}</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
