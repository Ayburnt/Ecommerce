    ...
    <div id="app">
        ...
        <div class="page-header">
            ...
            <nav class="navbar fixed-top navbar-expand-md navbar-dark bg-transparent" id="page-navigation">
                <div class="container">
                    <!-- Navbar Brand -->
                    <a href="{{ url(path: '/') }}" class="navbar-brand">
                            ...
                            @else
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" id="navbarDropdown"
                                        ...
                                        aria-expanded="false">
                                        <div class="avatar-header"><img src="{{asset('assets/users_images/'.Auth::user()->image.'')}}"></div>
                                        {{ Auth::user()->name }}
                                    </a>
        ...
        <footer>
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <h5>About</h5>
                        <p>Nisi esse dolor irure dolor eiusmod ex deserunt proident cillum eu qui enim occaecat sunt
                            aliqua anim eiusmod qui ut voluptate.</p>
                    </div>
                    <div class="col-md-3">
                        <h5>Links</h5>
                        <ul>
