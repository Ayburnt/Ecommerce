                        ...
                        <form action="{{ route('products.process.checkout') }}" method="POST" class="bill-detail">
                            <fieldset>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col">
                                        <input class="form-control" name="price" value="{{ $checkoutSubtotal + 50 }}"
                                            type="tel">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary d-flex justify-content-center align-items-center"
                                    name="submit" type="submit" style="width: 40px; height: 40px; border-radius: 50%;">
                                ...
                                <table class="table">
                                    ...
                                    <tfooter>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <strong>Php {{ $checkoutSubtotal + 50 }}</strong>
                                            </td>
                                        </tr>
                                    </tfooter>
                                </table>
